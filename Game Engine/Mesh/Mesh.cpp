...
Mesh::Mesh(std::vector<Vertex> vertices, const GLchar* texture_diffuse, const GLchar* texture_specular) {
...
void Mesh::DrawNoIndices(Shader shader, glm::mat4 model) {
	/*if (this->shadow == nullptr) {
		ShadowSetter::Shadow Shadow(this->diffuseMap, this->VAO);
...
void Mesh::DrawShadows(Shader shader, glm::vec3 lightPos, glm::mat4 lightSpaceMatrix) {
	/*
